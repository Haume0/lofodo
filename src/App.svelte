...
<main class="absolute w-screen noslc flex h-screen !bg-cover !bg-center overflow-hidden bg-black">
  ...
  <div class:!translate-y-0={show == true} class:yt_full={fullsc == true} class="absolute noslc ease-in-out duration-500 md:bottom-10 sm:bottom-4 md:translate-y-[calc(100%+40px)] sm:translate-y-[calc(150%-24px)] w-[90vw] max-w-[440px] min-h-[80px] md:left-10 sm:left-4 flex flex-col gap-1">
    <!-- svelte-ignore a11y-click-events-have-key-events -->
